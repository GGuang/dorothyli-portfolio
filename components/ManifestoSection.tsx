    ...
    >
      <div className="w-full px-6 pt-20 pb-20 lg:max-w-content lg:mx-auto lg:px-14 lg:pt-32 lg:pb-32 xl:px-[5.5%]">
        ...
        <h2 className="font-serif font-[400] tracking-tight text-4xl leading-[1.15] lg:text-4xl xl:text-5xl lg:leading-[1.1] lg:max-w-[65%] text-ink">
          Dorothy Li turns complex B2B products into global marketing systems, connecting brand, content, search, and demand across borders.
        </h2>
        ...
        <div className="lg:flex lg:justify-end">
          <p className="font-sans font-[400] text-base leading-[1.65] lg:text-lg lg:leading-[1.6] text-ink/80 lg:max-w-[42%]">
            Built across agency campaigns, brand localisation, content growth, and B2B technology marketing, my work focuses on making complex offerings easier to understand, easier to find, and easier to scale through structured content, search, and AI-assisted workflows.
          </p>
        </div>
